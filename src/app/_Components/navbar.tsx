...
function Navbar() {
  ...
  useEffect(() => {
    ...
    const FcLikeItems = JSON.parse(localStorage.getItem("likes") || "[]");
    setlikeLength(FcLikeItems.length);
  }, []);
  ...
  return (
    <div className="shadow-sm w-full max-w-[1500px] flex justify-between items-center mx-auto py-3 px-4 lg:px-6 rounded-lg">
      <div className="shadow-lg h-16 w-28 flex items-center justify-center rounded-2xl">
        <svg
      ...
      <ul className="hidden md:flex gap-6 text-lg font-semibold">
        <li>
          <a
            href="#"
            className="text-black hover:text-gray-300 decoration-transparent"
          >
            Home
          </a>
        </li>
      ...
      <div className="hidden md:flex items-center gap-4">
        <div className="relative">
          ...
          <button
            onClick={() => (location.href = "/add_to_like")}
            className="bg-gray-100 text-black px-4 py-2 rounded-md shadow hover:bg-gray-200"
          >
        ...
        <button
          onClick={handleAuth}
          className="bg-blue-500 text-white px-2 py-2 flex items-center gap-2 rounded-md shadow hover:bg-blue-600"
        >
          {localId ? (
            <>
              <BiLogOut onClick={() => (location.href = "/")} /> Sign Out
            </>
          ) : (
            <>
              <BiLogIn /> Sign In
      ...
      {isOpen && (
        <ul className="absolute z-10 top-20 left-0 w-full bg-white flex flex-col gap-4 p-4 text-lg font-semibold md:hidden">
          <li>
          ...
          <button className="bg-gray-100 text-black px-4 py-2 rounded-md shadow hover:bg-gray-200">
